 ...
 */
public class HolderAccelerometerScannedDevice extends RecyclerView.ViewHolder{
    ...
    public HolderAccelerometerScannedDevice(View itemView) {
        super(itemView);
    ...
    public void bind(ModelBleAccelerometer modelBle){
