...
import com.intugine.ble.beacon.ui.navigator.WrapperIndicatorView;
...
public class FragmentNavigator2d extends FragmentBase implements BleScanHandler.OnBleScannedListener,
        DialogPosition.DialogPositionListener,
        DialogWifi.DialogWifiListener,
        WebSocketClientHandler.ServerClientHandlerListener {

    private static final String TAG = makeLogTag(FragmentNavigator2d.class);
    ...
    public static Fragment newInstance(int position, Bundle bundle) {
        FragmentNavigator2d fragment = new FragmentNavigator2d();
    ...
    NavigationHandler2d mNavigationHandler;
    ...
    public int getLayoutResourceId() {
        return R.layout.navigate_2d_fragment;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mNavigationHandler = new NavigationHandler2d(getContext(), 4);
        ...
        if(activity!=null){
            ...
            try {
                ...
                WebSocketClientHandler.with(activity).setServerClientHandlerListener(FragmentNavigator2d.this);
...
//        vFab.setImageDrawable(playToStopAnim);
    ...
    private void startDialogPosition(int beaconIndicatorKey) {
        //FragmentTransaction ft = getFragmentManager().beginTransaction();
        Bundle b = new Bundle();
        //b.putString(DialogPosition.B_ARG_KEY, String.valueOf(beaconIndicatorKey));
        DialogPosition dialogPosition = DialogPosition.newInstance(beaconIndicatorKey, b);
        dialogPosition.setCancelable(false);
        dialogPosition.show(getFragmentManager(), DialogPosition.class.getSimpleName());
        dialogPosition.setDialogPositionListener(this);
    }

    @Override
    public void onDialogCommentPositiveClick(int key, String posiX, String posiY) {
        mNavigationHandler.attachBeaconToIndicator(key, mAdapterScannedBeacon.modelBleList, posiX, posiY);
